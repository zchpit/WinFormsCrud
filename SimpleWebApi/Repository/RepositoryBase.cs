...
namespace SimpleWebApi.Repository
{
    public abstract class RepositoryBase<T> : IRepositoryBase<T> where T : class
    {
        ...
        public async ValueTask<T> GetFirstWithNoTracking(Expression<Func<T, bool>> expression) => await repositoryContext.Set<T>().AsNoTracking().FirstOrDefaultAsync(expression);
